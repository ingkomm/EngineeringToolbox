  ...
  if (kind === "memo") {
    return (
      <svg viewBox="0 0 44 44" className="pid-symbol-svg" aria-label={title ?? "Memo"}>
        ...
        <line x1="13" y1="16" x2="31" y2="16" stroke="currentColor" strokeWidth="1.5" />
        <line x1="13" y1="22" x2="31" y2="22" stroke="currentColor" strokeWidth="1.5" />
        <line x1="13" y1="28" x2="24" y2="28" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    );
  }
  return (
