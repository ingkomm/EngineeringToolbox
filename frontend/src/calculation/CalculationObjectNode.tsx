...
import type { CalculationObject } from "./types";
import type { ProjectDocument } from "../shared/document";
import { formatValue, inputHandleId, outputHandleId } from "../shared/display";
import { OBJECT_LINK_HANDLE, objectLinkSideOf } from "../shared/worksheet";
...
import { OBJECT_ID_RE, VARIABLE_ID_RE, type WorkspaceEdit } from "../shared/projectEdits";
import { CALC_EXPANDED_MIN_WIDTH, calcCardWidth, snapCalcWidth } from "./cardWidth";
import { displayName } from "./variables";
import type { QuantitySpec } from "../shared/quantities";
